      ...
      <div className="hidden md:flex md:w-1/2 lg:w-3/5 relative overflow-hidden bg-inverse-surface">
        ...
        <div className="relative z-20 flex flex-col justify-end p-16 h-full max-w-2xl">
          ...
          <h1 className="font-headline text-5xl lg:text-7xl font-extrabold tracking-tighter text-white mb-6 leading-tight">
            Architecting <span className="text-primary-container">Generational</span> Wealth.
          </h1>
          <p className="text-secondary-fixed text-lg lg:text-xl font-light leading-relaxed max-w-md">
            Experience the digital standard of physical asset management. Your holdings, secured by the alchemy of precision technology and timeless value.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md flex flex-col">
          ...
          <div className="mb-12">
            ...
            <p className="font-label text-on-surface-variant text-sm">
              Masukkan kredensial Anda untuk mengakses aset aman Anda.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="relative group">
                <div className="flex justify-between items-end mb-2 ml-1">
                  ...
                  <Link href="/auth/forgot-password" className="text-[10px] uppercase tracking-widest font-bold text-primary hover:opacity-70 transition-opacity">
                    Lupa?
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="pt-4">
              ...
              >
                {loading ? 'Memproses...' : 'Masuk ke Brankas'} {!loading && '➔'}
              </button>
            </div>
          </form>
          ...
          <div className="mt-12 text-center">
            <p className="font-label text-sm text-on-surface-variant">
              Baru di sini?{' '}
              <Link href="/auth/sign-up" className="text-primary font-bold hover:underline underline-offset-4 ml-1">
                Daftar Akun
              </Link>
            </p>
          </div>
          ...
          {/* Security Badge */}
          <div className="mt-auto pt-16 flex items-center justify-center gap-6 opacity-40">
            <div className="flex items-center gap-2">
              <span>🔐</span>
